...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-695mwv$ykb&qd+koxt^zx1i$is(7s-qqoe^@0^3dveqq536sad')
...
# Upload limits (allow high-resolution photos without size restrictions)
